     ...
     $name = $player->getName();
      ...
      switch($data){
        ...
        case 0:
            ...
            $this->getServer()->dispatchCommand($player, "sb create" . " $name");
        ...
        case 3:
            ...
            $this->getServer()->dispatchCommand($player, "sb delete" . " $name");
    ...
    $form = $this->getServer()->getPluginManager()->getPlugin("FormAPI")->createSimpleForm(function (Player $player, int $data = null){
      ...
      switch($data){
        ...
        case 0:
            ...
            $this->getServer()->dispatchCommand($player, "sb invite");

        break;

        case 1:

            $this->getServer()->dispatchCommand($player, "sb accept");
